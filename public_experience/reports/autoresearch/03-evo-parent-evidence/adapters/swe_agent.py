...
class SWEAgent(Adapter):
    ...
    def smith(self):
        ...
        for p in sorted((ROOT/'raw/swe_agent').glob('**/tool-*.parquet')):
            row_no=0
    ...
    def parse_messages(self,p,row_no,d):
        ...
        return finish(self.source,rid,ns,es,dataset='SWE-bench/SWE-smith-trajectories/tool',structure='linear',
